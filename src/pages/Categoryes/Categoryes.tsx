...
const Categoryes = () => {
  ...
  const filterProducts = useSelector((state: any) => state?.filtereds?.searchData?.data);
  ...
  return (
    <div className="sectionContent">
      <div className="about_sectionContent">
        <span className="about_sectionContent_text">
          {t('about_sectionContent_text')} {searchInputChange}
        </span>
